...
# 合并 GD_All 和 PD_All 数据
df_all = pd.concat([df_gd_all, df_pd_all], ignore_index=True)

# 将相关列转换为数值类型
df_all['Size'] = pd.to_numeric(df_all['Size'], errors='coerce')
df_all['Brightness'] = pd.to_numeric(df_all['Brightness'], errors='coerce')
df_all['ViewAngle_H'] = pd.to_numeric(df_all['ViewAngle_H'], errors='coerce')
df_all['ViewAngle_V'] = pd.to_numeric(df_all['ViewAngle_V'], errors='coerce')
df_all['Temp_L'] = pd.to_numeric(df_all['Temp_L'], errors='coerce')
df_all['Temp_H'] = pd.to_numeric(df_all['Temp_H'], errors='coerce')
